    ...
    return (
        <div className='flex justify-around items-center'>
            <div>
                ...
                <p className='w-[500px] text-yellow-50 text-xl '>I break down complex user experinece problems to create integritiy focussed solutions that connect billions of people</p>
                <div className='flex gap-5 items-center'>
                    <button className='btn'>Download Resume <span><FaArrowDown></FaArrowDown></span></button>
